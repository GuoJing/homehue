...
from config import STATION_IP, DEVICE_TYPE
...
class Hue(HueHttpMixin):
    ...
    def __init__(self, station_ip='', devicetype=''):
        self.station_ip = station_ip or STATION_IP
        self.devicetype = devicetype or DEVICE_TYPE
